...
--
-- Host: localhost
-- Generation Time: Nov 01, 2012 at 06:13 PM
...
(20, 'mata', 22, 'mata', '2012-11-01', 'E:\\webdev\\apache\\htdocs\\webroot\\uploads\\mata\\cvr_img\\', 'E:\\webdev\\apache\\htdocs\\webroot\\uploads\\mata\\ebook\\', 1, 13, 1);
...
(4, 'test', 'test', 'test', 'test', 'test', 1, 1, '', 0),
(8, 'newuser', 'newuser', 'newuser', 'newuser', 'newuser', 1, 1, '', 0),
(12, 'usr', 'fn', 'ln', 'mail', 'psw', 0, 1, '', 0),
(13, 'root', 'root', 'root', 'root', 'root', 0, 7, '', 1),
(15, 'xao', 'Dicu', 'George', 'xao_geo007@yahoo.com', 'test', 0, 3, '0ff39bbbf981ac0151d340c9aa40e63e', 1),
(16, 'barfoo', 'florin', 'test', 'foo@bar.com', 'barfoo', 0, 3, '289dff07669d7a23de0ef88d2f7129e7', 0);
...
ALTER TABLE `user_book_rating`
  ADD CONSTRAINT `user_book_rating_ibfk_3` FOREIGN KEY (`id_book`) REFERENCES `books` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
